...
public class DateEx {
	...
	private static void calendarEx() {
		...
		//내부 정보를 얻어올 때는 get(날짜 상수)
		System.out.printf("현재: %d년 %d월 %d일%n",now.get(Calendar.YEAR),now.get(Calendar.MONTH)+1,//중요: 1월은 0
		...
		System.out.printf("미래: %d년 %d월 %d일%n", future.get(Calendar.YEAR),
